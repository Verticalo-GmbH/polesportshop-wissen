...
| E101 | CRAWLING-DATEN | Shop-Qualität: (1) Variation-`Darstellungsform = TEXTSWATCHES` (Größen-Swatches statt Dropdown); (2) Charm-VK `pricing.charm_vk` — runde Zehner-Beträge vermeiden (X0,90 → X9,90), nach E98-Aufschlag, erhält ,90; (3) `artikeldetails` aus Crawl mit verkaufsfördernden Infos anreichern (nach Ermessen, Stil E74/E78/E82) |
